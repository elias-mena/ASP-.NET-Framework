<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="delete.aspx.cs" Inherits="Taller2.delete" %>
...
<body>
    ...
    <form id="form1" runat="server" class="mt-5">
        <div>
            <h2 class="mb-5">Eliminar Alumno</h2>
            ...
            <asp:Button ID="ButtonEliminar" runat="server" Text="Borrar" OnClick="ButtonEliminar_Click" CssClass="btn btn-lg btn-warning btn-block mt-2"/>
            <button type="button" class="btn btn-lg btn-secondary btn-block mt-2">
                <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/actions.aspx">Regresar</asp:HyperLink>
                    ...
                    <br />
            <br />
            <h6 class="d-flex align-items-center justify-content-center"><asp:Label ID="LabelAlert" runat="server" Text=""></asp:Label> </h6>
    </form>
    </div>
