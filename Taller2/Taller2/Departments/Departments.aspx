<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Departments.aspx.cs" Inherits="FixedAssets.Departments.Departments" %>
                        ...
                        <div class="modal-content">
                            ...
                            <ul class="list-group list-group-flush">
                                ...
                                <li class="list-group-item">    
                                    ...
                                    <asp:TextBox ID="TextBoxDescription" runat="server" ID="TextBoxDescription" runat="server" CssClass="form-control" 
